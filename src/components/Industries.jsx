...
const industries = [
  {
    ...
    label: 'Coffee Houses',
    icon:  '☕',
    desc:  'Sales tracking, ingredient management & loyalty programs',
    color: '#F59E0B',
  ...
  },
  {
    ...
    label: 'Supermarkets',
    icon:  '🏪',
    desc:  'Inventory control, supplier management & category analytics',
    color: '#10B981',
  ...
  },
  {
    ...
    label: 'Retail Stores',
    icon:  '🛒',
    desc:  'Product performance, sales trends & operational metrics',
    color: '#2B68E9',
  ...
  },
  {
    ...
    label: 'Jewelry Shops',
    icon:  '💍',
    desc:  'Stock valuation, sales mix analysis & high-value tracking',
    color: '#EC4899',
  ...
  },
  {
    ...
    icon:  '👗',
    desc:  'Size/color analytics, return rates & seasonal trends',
    color: '#8B5CF6',
    demo:  '/clarix-solutions-website-/retail/index.html',
  },
  {
    ...
    label: 'Restaurants',
    icon:  '🍽️',
    desc:  'Order management, table tracking & kitchen operations',
    color: '#EF4444',
  ...
  },
  {
    ...
    label: 'Pharmacies',
    icon:  '💊',
    desc:  'Medicine inventory, expiry tracking & sales performance',
    color: '#06B6D4',
    demo:  '/clarix-solutions-website-/logistics/index.html',
  },
  {
    img:   'https://images.unsplash.com/photo-1509440159596-0249088772ff?auto=format&fit=crop&w=600&q=80',
    label: 'Bakeries',
    icon:  '🥐',
    desc:  'Daily production planning, waste reduction & ingredient costs',
    color: '#F97316',
          ...
          {industries.map((ind, i) => (
            ...
            >
              ...
              <div className="ind-card-img-wrap">
                <img src={ind.img} alt={ind.label} loading="lazy" className="ind-card-img" />
                <div className="ind-card-img-overlay" style={{ '--ind-color': ind.color }} />
                <span className="ind-card-icon">{ind.icon}</span>
              </div>

              {/* Body */}
              <div className="ind-card-body">
                <h4 className="ind-card-title">{ind.label}</h4>
